...
class Root(Tk):
    '''creates a graphics window. A few frames.'''
...
def made_convert(mes1, mes2, mes3):
    '''defines the file name and directory. Starts the conversion'''
    global dir_our_file
    global nameFile
...
def fill_excel(mes1, mes2, mes3):
    '''creates and fills the excel. First, formatting is created, then the cells are filled'''
